...
--
-- Table structure for table `selling_auction`
--

DROP TABLE IF EXISTS `selling_auction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `selling_auction`
--

LOCK TABLES `selling_auction` WRITE;
/*!40000 ALTER TABLE `selling_auction` DISABLE KEYS */;
/*!40000 ALTER TABLE `selling_auction` ENABLE KEYS */;
UNLOCK TABLES;
